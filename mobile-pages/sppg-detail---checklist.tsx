...
export function SPPGDetailChecklist() {
  return (
    <div className="flex flex-col min-h-screen w-full bg-background font-sans text-foreground">
      ...
      <main eid="e19" className="flex-1 px-6 -mt-20 pb-6 space-y-6 relative z-10 pb-40">
        <section eid="e60" className="space-y-4 pb-8">
          <div className="flex gap-2 p-1 bg-white border border-border shadow-xl rounded-full">
            <button className="flex-1 py-2.5 px-4 rounded-xl font-bold text-sm transition-all text-white bg-secondary-foreground">
              Checklist
            </button>
          ...
          <div className="bg-white p-6 rounded-3xl border border-border shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="size-10 rounded-xl bg-primary/10 flex items-center justify-center">
                <Icon icon="solar:checklist-bold" className="size-5 text-primary" />
              </div>
              <h3 className="font-bold text-lg font-heading">Checklist Persiapan</h3>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-muted/30 border border-border/50">
                <Icon
                  icon="solar:check-circle-bold"
                  className="size-6 text-chart-4 flex-shrink-0"
                />
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-muted/30 border border-border/50">
                ...
                />
                <p className="text-xs font-bold text-foreground flex-1">
                  Alat dapur, alat masak, dan alat makan lengkap
                </p>
                <span className="text-sm font-extrabold text-foreground">10%</span>
              </div>
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-muted/30 border border-border/50">
                ...
                />
                <p className="text-xs font-bold text-foreground flex-1">
                  Instalasi listrik, air dan gas berfungsi
                </p>
                <span className="text-sm font-extrabold text-foreground">10%</span>
              </div>
            </div>
